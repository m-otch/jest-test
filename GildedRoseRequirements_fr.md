...
- Une fois que la date de péremption est passée, la qualité se dégrade deux fois plus rapidement. -- Ok
- La qualité (`quality`) d'un produit ne peut jamais être négative. -- Ok
- "Aged Brie" augmente sa qualité (`quality`) plus le temps passe. -- Ok
- La qualité d'un produit n'est jamais de plus de 50. -- Ok
- "Sulfuras", étant un objet légendaire, n'a pas de date de péremption et ne perd jamais en qualité (`quality`) -- Ok
- "Backstage passes", comme le "Aged Brie", augmente sa qualité (`quality`) plus le temps passe (`sellIn`) ; La qualité augmente de 2 quand il reste 10 jours ou moins et de 3 quand il reste 5 jours ou moins, mais la qualité tombe à 0 après le concert. -- Ok
